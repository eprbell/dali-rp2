...
from dali.plugin.input.rest.binance_us import InputPlugin
...
class TestBinance:
    def test_deposits(self, mocker: Any) -> None:
        ...
        assert crypto_deposit_transaction.to_exchange == "Binance.us"
    ...
    def test_withdrawals(self, mocker: Any) -> None:
        ...
        assert crypto_withdrawal_transaction.from_exchange == "Binance.us"
