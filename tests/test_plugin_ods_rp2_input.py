...
class TestRP2InputOds:
    ...
    def test_in_transactions(self) -> None:
        ...
        assert RP2Decimal(btc_transaction_in_2.crypto_in) == RP2Decimal("0.99")
    ...
    def test_out_transactions(self) -> None:
        ...
        assert RP2Decimal(btc_transaction_out_1.spot_price) == RP2Decimal("44628.22")
        assert RP2Decimal(btc_transaction_out_1.crypto_out_no_fee) == RP2Decimal("0.02")
        assert RP2Decimal(btc_transaction_out_1.crypto_out_with_fee) == RP2Decimal("0.02")
        assert RP2Decimal(btc_transaction_out_1.crypto_fee) == ZERO
    ...
    def test_intra_transactions(self) -> None:
        ...
        assert RP2Decimal(btc_transaction_intra_1.spot_price) == RP2Decimal("41952.11")
        ...
        assert RP2Decimal(btc_transaction_intra_1.crypto_sent) == RP2Decimal("0.2002")
        assert RP2Decimal(btc_transaction_intra_1.crypto_received) == RP2Decimal("0.20")
        ...
        assert RP2Decimal(btc_transaction_intra_2.spot_price) == RP2Decimal("41736.81")
        ...
        assert RP2Decimal(btc_transaction_intra_2.crypto_sent) == RP2Decimal("0.1001")
        assert RP2Decimal(btc_transaction_intra_2.crypto_received) == RP2Decimal("0.10")
        ...
        assert RP2Decimal(btc_transaction_intra_3.spot_price) == RP2Decimal("36463.4")
        ...
        assert RP2Decimal(btc_transaction_intra_3.crypto_sent) == RP2Decimal("0.0503")
        assert RP2Decimal(btc_transaction_intra_3.crypto_received) == RP2Decimal("0.05")
