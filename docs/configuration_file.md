...
If you have the existing RP2 input files (The config and data in the .ods file generated by dali-rp2). You can use that as input for dali if you would like to 
generate a new output that is combined with other plugins you pair with it. An example might be; you want to combine your old data used from a previous
tax return with new data, or you want to combine multiple rp2 configs and data inputs into a single .ods file and single config file.
...
country=us
from_date=2021-01-01T00:00:00 ;optional
to_date=2021-12-31T00:00:00 ;optional
