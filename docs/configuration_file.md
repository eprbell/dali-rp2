...
### Kraken Section (REST)
This plugin is REST-based and requires setting up API Keys in your Kraken account settings (click on the API link).
...
Note: the `use_cache`, `native_fiat` parameters are optional. 
