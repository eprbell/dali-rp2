...
# Binance.us REST plugin links:
# REST API: https://docs.binance.us/#rest-api
# Authentication: https://docs.binance.us/#authentication
...
from ccxt import Exchange, binanceus
...
class InputPlugin(AbstractCcxtInputPlugin):
    __EXCHANGE_NAME: str = "Binance.us"
    __PLUGIN_NAME: str = "Binance.us_REST"
    ...
    def _initialize_client(self) -> binanceus:
        return binanceus(
            {
    ...
    def _client(self) -> binanceus:
        ...
        if not isinstance(super_client, binanceus):
