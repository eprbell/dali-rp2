        ...
        if transaction_details[_TRANSFER_TYPE] == _DEPOSIT:
            ...
            intra_transaction_list.append(
                IntraTransaction(
                    ...
                    None,  # Spot price
                    str(amount),
                    Keyword.UNKNOWN.value,  # Received amount
                )
            )
        else:
        ...
        if (is_from_currency_fiat and not is_to_currency_fiat and fill_side == _SELL) or (  # pylint: disable=too-many-boolean-expressions
            ...
            self.__append_transaction(
                ...
                cast(
                    ...
                    InTransaction(
                        ...
                        json.dumps(transaction),
                        fill[_CREATED_AT],
                        to_currency if is_from_currency_fiat else from_currency,
                        self.__COINBASE_PRO,
                        self.account_holder,
                        "Buy",
                        str(spot_price),
            ...
            self.__append_transaction(
                ...
                cast(
                    ...
                    OutTransaction(
                        ...
                        json.dumps(transaction),
                        fill[_CREATED_AT],
                        from_currency if is_to_currency_fiat else from_currency,
                        self.__COINBASE_PRO,
                        self.account_holder,
                        "Sell",
                        str(spot_price),
            ...
            self.__append_transaction(
                ...
                OutTransaction(
                    ...
                    self.account_holder,
                    "Sell",
                    str(from_currency_price),
                    str(from_currency_size),
                    "0",
                    None,
                    None,
                    None,
            ...
            self.__append_transaction(
                ...
                InTransaction(
                    ...
                    self.account_holder,
                    "Buy",
                    str(to_currency_price),
                    str(to_currency_size),
                    "0",
                    None,
                    None,
